...
namespace BattleLogic
{
    ...
    public class BattleRandom
    {
        ...
        public BattleRandom() : this(Environment.TickCount)
        {
        ...
        public BattleRandom(int inext, int inextp, int[] seedArray)
        {
            this.inext = inext;
            this.inextp = inextp;
            seedArray.CopyTo(SeedArray, 0);
        }
        ...
        **Exceptions: None.
        ...
        public virtual int Next(int minValue, int maxValue)
        {
            ...
            {
                throw new ArgumentOutOfRangeException("itHasToBeLowerThanTheMax");
            }
        ...
        **Exceptions: None.
        ...
        public virtual int Next(int maxValue)
        {
            if (maxValue < 0)
            {
                throw new ArgumentOutOfRangeException("itHasToBePositive");
            }
            Contract.EndContractBlock();
